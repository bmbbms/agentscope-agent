...
**表名**: `edw.chn_stat_org_trd_1d`

## 表结构

| 字段名 | 类型 | 注释 |
|--------|------|------|
| stat_date | string | 统计日期yyyyMMdd |
| product_type | string | 产品大类 |
| branch_org | string | 机构 |
...
| unpay_amt | string | 银联交易金额 |
| unpay_cnt | string | 银联交易笔数 |
