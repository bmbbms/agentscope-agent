# xacc.t_visa_err_list (visa差错账单)

| Column | Type | Extra | Comment |
|---|---|---|---|
| rowkey | varchar |  | rowkey |
| record_date | varchar |  | 记录日期  |
| record_type | varchar |  | 记录类型 |
| dispute_amount_indicator | varchar |  | 争议金额标识 |
| record_reference_number | varchar |  | 记录参考号 |
| record_reason_code | varchar |  | 记录理由码 |
| record_reference_information | varchar |  | 记录参考信息 |
